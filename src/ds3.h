...
LIBRARY_API void ds3_request_set_activated(const ds3_request* _request);
LIBRARY_API void ds3_request_set_aggregating(const ds3_request* _request);
LIBRARY_API void ds3_request_set_assigned_to_storage_domain(const ds3_request* _request);
LIBRARY_API void ds3_request_set_auth_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_auto_activate_timeout_in_mins(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_auto_eject_upon_cron(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_auto_eject_upon_job_cancellation(const ds3_request* _request);
LIBRARY_API void ds3_request_set_auto_eject_upon_job_completion(const ds3_request* _request);
LIBRARY_API void ds3_request_set_auto_eject_upon_media_full(const ds3_request* _request);
LIBRARY_API void ds3_request_set_auto_inspect_ds3_auto_inspect_mode(const ds3_request* _request, const ds3_auto_inspect_mode value);
LIBRARY_API void ds3_request_set_auto_reclaim_initiate_threshold(const ds3_request* _request, const float value);
LIBRARY_API void ds3_request_set_auto_reclaim_terminate_threshold(const ds3_request* _request, const float value);
LIBRARY_API void ds3_request_set_bar_code(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_blobbing_enabled(const ds3_request* _request);
LIBRARY_API void ds3_request_set_bucket_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_built_in(const ds3_request* _request);
LIBRARY_API void ds3_request_set_burst_threshold(const ds3_request* _request, const float value);
LIBRARY_API void ds3_request_set_checksum_type_ds3_checksum_type(const ds3_request* _request, const ds3_checksum_type value);
LIBRARY_API void ds3_request_set_chunk_client_processing_order_guarantee_ds3_job_chunk_client_processing_order_guarantee(const ds3_request* _request, const ds3_job_chunk_client_processing_order_guarantee value);
LIBRARY_API void ds3_request_set_conflict_resolution_mode_ds3_replication_conflict_resolution_mode(const ds3_request* _request, const ds3_replication_conflict_resolution_mode value);
LIBRARY_API void ds3_request_set_conflict_resolution_mode_ds3_import_conflict_resolution_mode(const ds3_request* _request, const ds3_import_conflict_resolution_mode value);
LIBRARY_API void ds3_request_set_created_at(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_data_policy_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_default_blob_size(const ds3_request* _request, const uint64_t value);
LIBRARY_API void ds3_request_set_default_data_policy_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_default_get_job_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_default_import_conflict_resolution_mode_ds3_import_conflict_resolution_mode(const ds3_request* _request, const ds3_import_conflict_resolution_mode value);
LIBRARY_API void ds3_request_set_default_put_job_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_default_verify_job_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_delimiter(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_density_ds3_tape_drive_type(const ds3_request* _request, const ds3_tape_drive_type value);
LIBRARY_API void ds3_request_set_dns_name(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_eject_label(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_eject_location(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_end_to_end_crc_required(const ds3_request* _request);
LIBRARY_API void ds3_request_set_error_message(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_folder(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_force(const ds3_request* _request);
LIBRARY_API void ds3_request_set_format_ds3_http_response_format_type(const ds3_request* _request, const ds3_http_response_format_type value);
LIBRARY_API void ds3_request_set_full_details(const ds3_request* _request);
LIBRARY_API void ds3_request_set_full_of_data(const ds3_request* _request);
LIBRARY_API void ds3_request_set_group_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_health_ds3_pool_health(const ds3_request* _request, const ds3_pool_health value);
LIBRARY_API void ds3_request_set_ignore_naming_conflicts(const ds3_request* _request);
LIBRARY_API void ds3_request_set_import_export_configuration_ds3_import_export_configuration(const ds3_request* _request, const ds3_import_export_configuration value);
LIBRARY_API void ds3_request_set_include_physical_placement(const ds3_request* _request);
LIBRARY_API void ds3_request_set_isolation_level_ds3_data_isolation_level(const ds3_request* _request, const ds3_data_isolation_level value);
LIBRARY_API void ds3_request_set_job(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_job_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_key_marker(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_last_page(const ds3_request* _request);
LIBRARY_API void ds3_request_set_latest(const ds3_request* _request);
LIBRARY_API void ds3_request_set_library_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_ltfs_file_naming_ds3_ltfs_file_naming_mode(const ds3_request* _request, const ds3_ltfs_file_naming_mode value);
LIBRARY_API void ds3_request_set_management_url(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_marker(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_max_capacity_in_bytes(const ds3_request* _request, const uint64_t value);
LIBRARY_API void ds3_request_set_max_keys(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_max_parts(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_max_tape_fragmentation_percent(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_max_upload_size(const ds3_request* _request, const uint64_t value);
LIBRARY_API void ds3_request_set_max_uploads(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_maximum_auto_verification_frequency_in_days(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_media_ejection_allowed(const ds3_request* _request);
LIBRARY_API void ds3_request_set_member_group_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_member_user_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_minimum_days_to_retain(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_name(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_naming_convention_ds3_naming_convention_type(const ds3_request* _request, const ds3_naming_convention_type value);
LIBRARY_API void ds3_request_set_node_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_notification_http_method_ds3_request_type(const ds3_request* _request, const ds3_request_type value);
LIBRARY_API void ds3_request_set_offset(const ds3_request* _request, const uint64_t value);
LIBRARY_API void ds3_request_set_page_length(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_page_offset(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_page_start_marker(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_part_number_marker(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_partition_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_permission_ds3_bucket_acl_permission(const ds3_request* _request, const ds3_bucket_acl_permission value);
LIBRARY_API void ds3_request_set_pool_health_ds3_pool_health(const ds3_request* _request, const ds3_pool_health value);
LIBRARY_API void ds3_request_set_pool_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_pool_partition_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_pool_state_ds3_pool_state(const ds3_request* _request, const ds3_pool_state value);
LIBRARY_API void ds3_request_set_pool_type_ds3_pool_type(const ds3_request* _request, const ds3_pool_type value);
LIBRARY_API void ds3_request_set_powered_on(const ds3_request* _request);
LIBRARY_API void ds3_request_set_preferred_number_of_chunks(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_prefix(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_previous_state_ds3_tape_state(const ds3_request* _request, const ds3_tape_state value);
LIBRARY_API void ds3_request_set_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_quiesced_ds3_quiesced(const ds3_request* _request, const ds3_quiesced value);
LIBRARY_API void ds3_request_set_rebuild_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_rechunked(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_request_type_ds3_job_request_type(const ds3_request* _request, const ds3_job_request_type value);
LIBRARY_API void ds3_request_set_roll_back(const ds3_request* _request);
LIBRARY_API void ds3_request_set_serial_number(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_state_ds3_data_persistence_rule_state(const ds3_request* _request, const ds3_data_persistence_rule_state value);
LIBRARY_API void ds3_request_set_state_ds3_pool_state(const ds3_request* _request, const ds3_pool_state value);
LIBRARY_API void ds3_request_set_state_ds3_storage_domain_member_state(const ds3_request* _request, const ds3_storage_domain_member_state value);
LIBRARY_API void ds3_request_set_state_ds3_tape_drive_state(const ds3_request* _request, const ds3_tape_drive_state value);
LIBRARY_API void ds3_request_set_state_ds3_tape_partition_state(const ds3_request* _request, const ds3_tape_partition_state value);
LIBRARY_API void ds3_request_set_state_ds3_tape_state(const ds3_request* _request, const ds3_tape_state value);
LIBRARY_API void ds3_request_set_storage_domain_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_tape_drive_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_tape_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_tape_partition_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_tape_state_ds3_tape_state(const ds3_request* _request, const ds3_tape_state value);
LIBRARY_API void ds3_request_set_tape_type_ds3_tape_type(const ds3_request* _request, const ds3_tape_type value);
LIBRARY_API void ds3_request_set_task_priority_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_truncated(const ds3_request* _request);
LIBRARY_API void ds3_request_set_type_ds3_data_persistence_rule_type(const ds3_request* _request, const ds3_data_persistence_rule_type value);
LIBRARY_API void ds3_request_set_type_ds3_s3_object_type(const ds3_request* _request, const ds3_s3_object_type value);
LIBRARY_API void ds3_request_set_type_ds3_pool_failure_type(const ds3_request* _request, const ds3_pool_failure_type value);
LIBRARY_API void ds3_request_set_type_ds3_pool_type(const ds3_request* _request, const ds3_pool_type value);
LIBRARY_API void ds3_request_set_type_ds3_storage_domain_failure_type(const ds3_request* _request, const ds3_storage_domain_failure_type value);
LIBRARY_API void ds3_request_set_type_ds3_system_failure_type(const ds3_request* _request, const ds3_system_failure_type value);
LIBRARY_API void ds3_request_set_type_ds3_tape_drive_type(const ds3_request* _request, const ds3_tape_drive_type value);
LIBRARY_API void ds3_request_set_type_ds3_tape_failure_type(const ds3_request* _request, const ds3_tape_failure_type value);
LIBRARY_API void ds3_request_set_type_ds3_tape_partition_failure_type(const ds3_request* _request, const ds3_tape_partition_failure_type value);
LIBRARY_API void ds3_request_set_type_ds3_tape_type(const ds3_request* _request, const ds3_tape_type value);
LIBRARY_API void ds3_request_set_unavailable_media_policy_ds3_unavailable_media_usage_policy(const ds3_request* _request, const ds3_unavailable_media_usage_policy value);
LIBRARY_API void ds3_request_set_unavailable_pool_max_job_retry_in_mins(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_unavailable_tape_partition_max_job_retry_in_mins(const ds3_request* _request, const int value);
LIBRARY_API void ds3_request_set_upload_id_marker(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_user_id(const ds3_request* _request, const char* value);
LIBRARY_API void ds3_request_set_verify_prior_to_auto_eject_ds3_priority(const ds3_request* _request, const ds3_priority value);
LIBRARY_API void ds3_request_set_version(const ds3_request* _request, const uint64_t value);
LIBRARY_API void ds3_request_set_versioning_ds3_versioning_level(const ds3_request* _request, const ds3_versioning_level value);
LIBRARY_API void ds3_request_set_write_optimization_ds3_write_optimization(const ds3_request* _request, const ds3_write_optimization value);
LIBRARY_API void ds3_request_set_write_preference_ds3_write_preference_level(const ds3_request* _request, const ds3_write_preference_level value);
LIBRARY_API void ds3_request_set_write_protected(const ds3_request* _request);
...
/* Optional Query Parameters for ds3_init_cancel_job_spectra_s3_request */
// void ds3_request_set_force(const ds3_request* _request)
...
/* Optional Query Parameters for ds3_init_get_tapes_with_full_details_spectra_s3_request */
// void ds3_request_set_assigned_to_storage_domain(const ds3_request* _request)
// void ds3_request_set_bar_code(const ds3_request* _request, const char* value)
// void ds3_request_set_bucket_id(const ds3_request* _request, const char* value)
// void ds3_request_set_eject_label(const ds3_request* _request, const char* value)
