...
LIBRARY_API void ds3_request_set_sha256(ds3_request* request, const char* md5);
LIBRARY_API void ds3_request_set_sha512(ds3_request* request, const char* md5);
LIBRARY_API void ds3_request_set_crc32(ds3_request* request, const char* md5);
LIBRARY_API void ds3_request_set_crc32c(ds3_request* request, const char* md5);
