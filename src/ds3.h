...
typedef enum {
    DS3_CLOUD_NAMING_MODE_BLACK_PEARL,
    DS3_CLOUD_NAMING_MODE_AWS_S3
}ds3_cloud_naming_mode;
typedef enum {
...
typedef enum {
    DS3_JOB_CREATION_FAILED_TYPE_DATA_UNAVAILABLE,
    DS3_JOB_CREATION_FAILED_TYPE_TAPES_MUST_BE_ONLINED
}ds3_job_creation_failed_type;
typedef enum {
...
typedef enum {
    ...
    DS3_S3_INITIAL_DATA_PLACEMENT_POLICY_DEEP_ARCHIVE
...
typedef enum {
    ...
    DS3_VERSIONING_LEVEL_KEEP_MULTIPLE_VERSIONS
...
typedef enum {
    DS3_BUCKET_HISTORY_EVENT_TYPE_DELETE,
    DS3_BUCKET_HISTORY_EVENT_TYPE_MARK_LATEST,
    DS3_BUCKET_HISTORY_EVENT_TYPE_UNMARK_LATEST,
    DS3_BUCKET_HISTORY_EVENT_TYPE_CREATE
}ds3_bucket_history_event_type;
typedef enum {
    DS3_CACHE_ENTRY_STATE_ALLOCATED,
    DS3_CACHE_ENTRY_STATE_IN_CACHE,
    DS3_CACHE_ENTRY_STATE_PENDING_DELETE
...
typedef enum {
    ...
    DS3_RESERVED_TASK_TYPE_MAINTENANCE,
...
typedef enum {
    ...
    DS3_TAPE_FAILURE_TYPE_DRIVE_TEST_FAILED,
    DS3_TAPE_FAILURE_TYPE_DRIVE_TEST_FAILED_ALL_WRITES_TOO_SLOW,
    ...
    DS3_TAPE_FAILURE_TYPE_DRIVE_TEST_SUCCEEDED,
    ...
    DS3_TAPE_FAILURE_TYPE_MOVE_FAILED,
    ...
    DS3_TAPE_FAILURE_TYPE_SINGLE_PARTITION,
    DS3_TAPE_FAILURE_TYPE_VERIFY_FAILED,
    DS3_TAPE_FAILURE_TYPE_WRITE_FAILED,
    DS3_TAPE_FAILURE_TYPE_WRITE_SOURCE_FAILED
}ds3_tape_failure_type;
typedef enum {
    DS3_TAPE_PARTITION_FAILURE_TYPE_AUTO_QUIESCED,
    ...
    DS3_TAPE_PARTITION_FAILURE_TYPE_TAPE_IN_INVALID_PARTITION
...
typedef enum {
    ...
    DS3_TAPE_STATE_AUTO_COMPACTION_IN_PROGRESS,
...
typedef enum {
    DS3_REST_DOMAIN_TYPE_ABM_CONFIG,
    ...
    DS3_REST_DOMAIN_TYPE_BUCKET_CHANGES_NOTIFICATION_REGISTRATION,
    DS3_REST_DOMAIN_TYPE_BUCKET_HISTORY,
    DS3_REST_DOMAIN_TYPE_CACHE_FILESYSTEM,
    DS3_REST_DOMAIN_TYPE_CACHE_STATE,
    DS3_REST_DOMAIN_TYPE_CACHE_THROTTLE_RULE,
    ...
    DS3_REST_DOMAIN_TYPE_JOB_CREATION_FAILED,
...
typedef enum {
    ...
    DS3_REST_OPERATION_TYPE_CANCEL_TEST,
    ...
    DS3_REST_OPERATION_TYPE_START_BULK_STAGE,
    DS3_REST_OPERATION_TYPE_START_BULK_VERIFY,
    DS3_REST_OPERATION_TYPE_TEST,
...
}ds3_azure_data_replication_rule_response;
typedef struct {
...
typedef struct {
    ...
    ds3_str* id;
    float max_cache_percent;
    ds3_priority priority;
    ds3_job_request_type request_type;
}ds3_cache_throttle_rule_response;
typedef struct {
    ds3_str* bucket_id;
...
typedef struct {
    ...
    int max_number_of_concurrent_jobs;
    int partially_verify_last_percent_of_tapes;
    ds3_bool pool_safety_enabled;
    ...
    ds3_bool verify_checkpoint_before_read;
...
typedef struct {
    ...
    ds3_job_creation_failed_type type;
    ds3_str* user_name;
...
typedef struct {
    ...
    ds3_str* target_id;
    ds3_data_replication_rule_type type;
}ds3_s3_data_replication_rule_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* creation_date;
    ds3_str* id;
...
typedef struct {
    ...
    ds3_str* user_id;
}ds3_azure_target_failure_notification_registration_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* creation_date;
    ds3_http_response_format_type format;
    ...
    int number_of_failures_since_last_success;
    ds3_str* user_id;
}ds3_bucket_changes_notification_registration_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* id;
    ds3_str* object_creation_date;
    ds3_str* object_name;
    uint64_t sequence_number;
    ds3_bucket_history_event_type type;
    ds3_str* version_id;
}ds3_bucket_history_event_response;
typedef struct {
    ds3_str* creation_date;
    ds3_http_response_format_type format;
    ds3_str* id;
...
typedef struct {
    ...
    int number_of_failures_since_last_success;
    ds3_str* user_id;
}ds3_s3_target_failure_notification_registration_response;
typedef struct {
    ds3_str* creation_date;
    ds3_http_response_format_type format;
    ds3_str* id;
...
typedef struct {
    ds3_bool allow_rollback;
    ds3_bool assigned_to_storage_domain;
    uint64_t available_raw_capacity;
    ds3_str* bar_code;
    ds3_str* bucket_id;
    ds3_str* characterization_ver;
...
typedef struct {
    ...
    ds3_str* name;
    ds3_cloud_naming_mode naming_mode;
    ds3_bool permit_going_out_of_sync;
    ds3_quiesced quiesced;
    ds3_target_state state;
}ds3_azure_target_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* id;
    ds3_str* name;
    ds3_str* target_id;
}ds3_azure_target_bucket_name_response;
typedef struct {
    ds3_str* date;
    ds3_str* error_message;
    ds3_str* id;
...
}ds3_azure_target_failure_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* id;
    ds3_target_read_preference_type read_preference;
    ds3_str* target_id;
}ds3_azure_target_read_preference_response;
typedef struct {
...
typedef struct {
    ...
    ds3_bool restricted_access;
    ds3_str* secret_key;
    int staged_data_expiration_in_days;
    ds3_target_state state;
}ds3_s3_target_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* id;
    ds3_str* name;
    ds3_str* target_id;
}ds3_s3_target_bucket_name_response;
typedef struct {
    ds3_str* date;
    ds3_str* error_message;
    ds3_str* id;
    ds3_str* target_id;
    ds3_target_failure_type type;
}ds3_s3_target_failure_response;
typedef struct {
    ds3_str* bucket_id;
    ds3_str* id;
    ds3_target_read_preference_type read_preference;
    ds3_str* target_id;
}ds3_s3_target_read_preference_response;
typedef struct {
    ds3_str* blob_id;
    ds3_str* id;
    ds3_str* target_id;
}ds3_suspect_blob_azure_target_response;
typedef struct {
    ds3_str* blob_id;
    ds3_str* id;
    ds3_str* target_id;
}ds3_suspect_blob_ds3_target_response;
typedef struct {
    ds3_str* blob_id;
    ds3_str* id;
    ds3_str* target_id;
}ds3_suspect_blob_s3_target_response;
typedef struct {
    ds3_str* branch;
    ds3_str* revision;
    ds3_str* version;
...
typedef struct {
    ...
    ds3_str* target_id;
    ds3_target_failure_type type;
}ds3_azure_target_failure_notification_payload_response;
typedef struct {
    ds3_str* date;
    ds3_str* error_message;
    ds3_str* notification_generation_date;
...
typedef struct {
    ...
    ds3_str* target_id;
    ds3_target_failure_type type;
}ds3_s3_target_failure_notification_payload_response;
typedef struct {
    ds3_str** tape_bar_codes;
...
typedef struct {
    ...
    ds3_data_placement_rule_state state;
    ds3_str* storage_domain_id;
    ds3_str* storage_domain_name;
    ds3_data_persistence_rule_type type;
}ds3_data_persistence_rule_api_bean_response;
typedef struct {
    ds3_str* id;
    ds3_bool replicate_deletes;
    ds3_data_placement_rule_state state;
    ...
    ds3_str* target_name;
    ds3_data_replication_rule_type type;
}ds3_data_replication_rule_api_bean_response;
typedef struct {
    ds3_str* code;
    ds3_str* key;
    ds3_str* message;
...
typedef struct {
    ds3_str* creation_date;
    ds3_str* name;
}ds3_human_readable_bucket_api_bean_response;
typedef struct {
    ds3_str* end_point;
    int http_port;
    int https_port;
...
typedef struct {
    ...
    int pool_count;
    ds3_pool_type type;
}ds3_pool_partition_api_bean_response;
typedef struct {
    ds3_str* key;
    ds3_str* version_id;
...
typedef struct {
    int auto_compaction_threshold;
    ds3_str* id;
    ds3_str* partition_name;
    ds3_str* pool_partition_id;
    ds3_storage_domain_member_state state;
    ds3_str* tape_partition_id;
    ds3_str* tape_type;
    ds3_write_preference_level write_preference;
}ds3_storage_domain_member_api_bean_response;
typedef struct {
    ds3_bool auto_compaction_enabled;
    ds3_bool auto_quiesce_enabled;
    int drive_count;
    ...
    ds3_tape_partition_state state;
    int tape_count;
}ds3_tape_partition_api_bean_response;
typedef struct {
    uint64_t available_storage_capacity;
    int count;
    uint64_t total_storage_capacity;
    ds3_str* type;
    uint64_t used_storage_capacity;
}ds3_tape_type_summary_api_bean_response;
typedef struct {
    ds3_cloud_naming_mode cloud_naming_mode;
    ds3_target_read_preference_type default_read_preference;
    ds3_str* id;
    ds3_str* name;
    ds3_bool permit_going_out_of_sync;
...
typedef struct {
    ds3_cache_throttle_rule_response** cache_throttle_rules;
    size_t num_cache_throttle_rules;
    ds3_paging* paging;
}ds3_cache_throttle_rule_list_response;
typedef struct {
    ds3_azure_data_replication_rule_response** azure_data_replication_rules;
    size_t num_azure_data_replication_rules;
    ds3_paging* paging;
}ds3_azure_data_replication_rule_list_response;
typedef struct {
...
typedef struct {
    ...
    ds3_paging* paging;
}ds3_s3_data_replication_rule_list_response;
typedef struct {
...
typedef struct {
    ...
    ds3_paging* paging;
}ds3_suspect_blob_s3_target_list_response;
typedef struct {
...
typedef struct {
    ds3_job_creation_failed_response** job_creation_faileds;
    size_t num_job_creation_faileds;
    ds3_paging* paging;
}ds3_job_creation_failed_list_response;
typedef struct {
    ds3_job_entry_response** job_entries;
    size_t num_job_entries;
    ds3_paging* paging;
}ds3_job_entry_list_response;
typedef struct {
...
typedef struct {
    ds3_bucket_changes_notification_registration_response** bucket_changes_notification_registrations;
    size_t num_bucket_changes_notification_registrations;
    ds3_paging* paging;
}ds3_bucket_changes_notification_registration_list_response;
typedef struct {
    ds3_bucket_history_event_response** bucket_history_events;
    size_t num_bucket_history_events;
    ds3_paging* paging;
}ds3_bucket_history_event_list_response;
typedef struct {
...
typedef struct {
    ...
    ds3_paging* paging;
}ds3_s3_target_failure_notification_registration_list_response;
typedef struct {
...
typedef struct {
    ...
    size_t num_feature_keys;
    ds3_paging* paging;
}ds3_feature_key_list_response;
typedef struct {
...
typedef struct {
    ds3_sequenced_event_response** changes;
    size_t num_changes;
    uint64_t last_processed_event;
    ds3_str* notification_generation_date;
}ds3_bucket_changes_notification_payload_response;
typedef struct {
...
typedef struct {
    ...
    ds3_str* description;
    ds3_str* drive_id;
    ds3_duration_response* duration_in_progress;
    ds3_duration_response* duration_scheduled;
    uint64_t id;
    ds3_str** job_ids;
    size_t num_job_ids;
    ds3_str* name;
...
typedef struct {
    ...
    ds3_bool always_minimize_spanning_across_media;
    ds3_bool blobbing_enabled;
    ds3_human_readable_bucket_api_bean_response** buckets;
    size_t num_buckets;
    ds3_checksum_type checksum_type;
    ds3_str* creation_date;
    ds3_data_persistence_rule_api_bean_response** data_persistence_rules;
    size_t num_data_persistence_rules;
    ds3_data_replication_rule_api_bean_response** data_replication_rules;
    ...
    ds3_priority rebuild_priority;
    ds3_versioning_level versioning;
}ds3_data_policy_api_bean_response;
typedef struct {
...
typedef struct {
    ...
    ds3_str* name;
    ds3_bool secure_media_allocation;
    ds3_storage_domain_member_api_bean_response** storage_domain_members;
    size_t num_storage_domain_members;
    ds3_priority verify_prior_to_auto_eject;
    ds3_write_optimization write_optimization;
}ds3_storage_domain_api_bean_response;
typedef struct {
    int count;
    int full_of_data;
    ds3_tape_state tape_state;
    ds3_type_type_count_api_bean_response** type_counts;
    size_t num_type_counts;
}ds3_tape_state_summary_api_bean_response;
typedef struct {
...
typedef struct {
    ...
    ds3_tape_partition_state state;
    int tape_count;
    ds3_tape_state_summary_api_bean_response** tape_state_summaries;
    size_t num_tape_state_summaries;
    ds3_tape_type_summary_api_bean_response** tape_type_summaries;
    size_t num_tape_type_summaries;
    ds3_str** tape_types;
...
typedef struct {
    ds3_data_policy_api_bean_response** data_policies;
    size_t num_data_policies;
    ds3_str* message;
    ds3_pool_partition_api_bean_response** pool_partitions;
    size_t num_pool_partitions;
    ds3_storage_domain_api_bean_response** storage_domains;
    size_t num_storage_domains;
    ds3_tape_partition_api_bean_response** tape_partitions;
    size_t num_tape_partitions;
    ds3_target_api_bean_response** targets;
    size_t num_targets;
}ds3_abm_config_api_bean_response;
typedef struct {
...
typedef struct {
    ds3_objects_response** completed_chunks;
    size_t num_completed_chunks;
    ds3_str* id;
    ds3_objects_response** incomplete_chunks;
    size_t num_incomplete_chunks;
    ds3_str* name;
}ds3_destination_summary_response;
typedef struct {
    ds3_bool auto_compaction_enabled;
    ds3_bool auto_quiesce_enabled;
    uint64_t available_storage_capacity;
...
typedef struct {
    ...
    ds3_job_chunk_client_processing_order_guarantee chunk_client_processing_order_guarantee;
    uint64_t completed_size_in_bytes;
    ds3_destination_summary_response** destination_summaries;
    size_t num_destination_summaries;
    ds3_bool entirely_in_cache;
    ds3_str* job_id;
    ds3_bool naked;
    ds3_str* name;
    ...
    ds3_str* user_id;
    ds3_str* user_name;
}ds3_job_summary_api_bean_response;
...
LIBRARY_API void ds3_cache_throttle_rule_response_free(ds3_cache_throttle_rule_response* response_data);
...
LIBRARY_API void ds3_job_creation_failed_response_free(ds3_job_creation_failed_response* response_data);
LIBRARY_API void ds3_job_entry_response_free(ds3_job_entry_response* response_data);
...
LIBRARY_API void ds3_bucket_changes_notification_registration_response_free(ds3_bucket_changes_notification_registration_response* response_data);
LIBRARY_API void ds3_bucket_history_event_response_free(ds3_bucket_history_event_response* response_data);
...
LIBRARY_API void ds3_data_persistence_rule_api_bean_response_free(ds3_data_persistence_rule_api_bean_response* response_data);
LIBRARY_API void ds3_data_replication_rule_api_bean_response_free(ds3_data_replication_rule_api_bean_response* response_data);
...
LIBRARY_API void ds3_human_readable_bucket_api_bean_response_free(ds3_human_readable_bucket_api_bean_response* response_data);
LIBRARY_API void ds3_job_node_response_free(ds3_job_node_response* response_data);
LIBRARY_API void ds3_pool_partition_api_bean_response_free(ds3_pool_partition_api_bean_response* response_data);
LIBRARY_API void ds3_s3_object_to_delete_response_free(ds3_s3_object_to_delete_response* response_data);
LIBRARY_API void ds3_storage_domain_member_api_bean_response_free(ds3_storage_domain_member_api_bean_response* response_data);
LIBRARY_API void ds3_tape_partition_api_bean_response_free(ds3_tape_partition_api_bean_response* response_data);
LIBRARY_API void ds3_tape_type_summary_api_bean_response_free(ds3_tape_type_summary_api_bean_response* response_data);
LIBRARY_API void ds3_target_api_bean_response_free(ds3_target_api_bean_response* response_data);
LIBRARY_API void ds3_type_type_count_api_bean_response_free(ds3_type_type_count_api_bean_response* response_data);
...
LIBRARY_API void ds3_sequenced_event_response_free(ds3_sequenced_event_response* response_data);
...
LIBRARY_API void ds3_cache_throttle_rule_list_response_free(ds3_cache_throttle_rule_list_response* response_data);
...
LIBRARY_API void ds3_job_creation_failed_list_response_free(ds3_job_creation_failed_list_response* response_data);
LIBRARY_API void ds3_job_entry_list_response_free(ds3_job_entry_list_response* response_data);
...
LIBRARY_API void ds3_bucket_changes_notification_registration_list_response_free(ds3_bucket_changes_notification_registration_list_response* response_data);
LIBRARY_API void ds3_bucket_history_event_list_response_free(ds3_bucket_history_event_list_response* response_data);
...
LIBRARY_API void ds3_bucket_changes_notification_payload_response_free(ds3_bucket_changes_notification_payload_response* response_data);
...
LIBRARY_API void ds3_data_policy_api_bean_response_free(ds3_data_policy_api_bean_response* response_data);
...
LIBRARY_API void ds3_storage_domain_api_bean_response_free(ds3_storage_domain_api_bean_response* response_data);
LIBRARY_API void ds3_tape_state_summary_api_bean_response_free(ds3_tape_state_summary_api_bean_response* response_data);
...
LIBRARY_API void ds3_abm_config_api_bean_response_free(ds3_abm_config_api_bean_response* response_data);
LIBRARY_API void ds3_list_bucket_result_response_free(ds3_list_bucket_result_response* response_data);
LIBRARY_API void ds3_destination_summary_response_free(ds3_destination_summary_response* response_data);
LIBRARY_API void ds3_detailed_tape_partition_response_free(ds3_detailed_tape_partition_response* response_data);
LIBRARY_API void ds3_job_summary_api_bean_response_free(ds3_job_summary_api_bean_response* response_data);
...
LIBRARY_API void ds3_request_set_allow_rollback(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_always_rollback(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_bucket(const ds3_request* request, const char * const value);
...
LIBRARY_API void ds3_request_set_cache_safety_enabled(const ds3_request* request, ds3_bool value);
LIBRARY_API void ds3_request_set_cached_only(const ds3_request* request, ds3_bool value);
LIBRARY_API void ds3_request_set_canceled_due_to_timeout(const ds3_request* request, ds3_bool value);
LIBRARY_API void ds3_request_set_characterize(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_date(const ds3_request* request, const char * const value);
LIBRARY_API void ds3_request_set_dead_job_cleanup_allowed(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_max_cache_percent(const ds3_request* request, const float value);
...
LIBRARY_API void ds3_request_set_max_number_of_concurrent_jobs(const ds3_request* request, const int value);
...
LIBRARY_API void ds3_request_set_min_sequence_number(const ds3_request* request, const uint64_t value);
...
LIBRARY_API void ds3_request_set_minimum_task_priority_ds3_priority(const ds3_request* request, const ds3_priority value);
...
LIBRARY_API void ds3_request_set_naming_mode_ds3_cloud_naming_mode(const ds3_request* request, const ds3_cloud_naming_mode value);
LIBRARY_API void ds3_request_set_needs_reconcile(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_partition(const ds3_request* request, const char * const value);
...
LIBRARY_API void ds3_request_set_pool_safety_enabled(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_pre_allocate_job_space(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_protected(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_restricted_access(const ds3_request* request, ds3_bool value);
LIBRARY_API void ds3_request_set_role_ds3_tape_role(const ds3_request* request, const ds3_tape_role value);
...
LIBRARY_API void ds3_request_set_size(const ds3_request* request, const uint64_t value);
LIBRARY_API void ds3_request_set_skip_clean(const ds3_request* request, ds3_bool value);
...
LIBRARY_API void ds3_request_set_user_name(const ds3_request* request, const char * const value);
LIBRARY_API void ds3_request_set_verify_after_write(const ds3_request* request, ds3_bool value);
LIBRARY_API void ds3_request_set_verify_checkpoint_before_read(const ds3_request* request, ds3_bool value);
...
/**
 * Optional Request Modifiers for ds3_init_complete_blob_request
 *
 *   void ds3_request_set_size(const ds3_request* request, const uint64_t value)
 */
LIBRARY_API ds3_request* ds3_init_complete_blob_request(const char *const bucket_name, const char *const object_name, const char* blob, const char* job);
LIBRARY_API ds3_error* ds3_complete_blob_request(const ds3_client* client, const ds3_request* request);
...
/**
 * Optional Request Modifiers for ds3_init_put_cache_throttle_rule_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 ...
 */
LIBRARY_API ds3_request* ds3_init_put_cache_throttle_rule_spectra_s3_request(const float max_cache_percent);
LIBRARY_API ds3_error* ds3_put_cache_throttle_rule_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_cache_throttle_rule_response** response);
LIBRARY_API ds3_request* ds3_init_delete_cache_throttle_rule_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_delete_cache_throttle_rule_spectra_s3_request(const ds3_client* client, const ds3_request* request);
...
LIBRARY_API ds3_request* ds3_init_get_cache_throttle_rule_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_get_cache_throttle_rule_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_cache_throttle_rule_response** response);
/**
 * Optional Request Modifiers for ds3_init_get_cache_throttle_rules_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_burst_threshold(const ds3_request* request, const float value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_max_cache_percent(const ds3_request* request, const float value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
 *   void ds3_request_set_page_start_marker(const ds3_request* request, const char * const value)
 *   void ds3_request_set_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 *   void ds3_request_set_request_type_ds3_job_request_type(const ds3_request* request, const ds3_job_request_type value)
 */
LIBRARY_API ds3_request* ds3_init_get_cache_throttle_rules_spectra_s3_request(void);
LIBRARY_API ds3_error* ds3_get_cache_throttle_rules_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_cache_throttle_rule_list_response** response);
/**
...
/**
 * Optional Request Modifiers for ds3_init_modify_cache_throttle_rule_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_burst_threshold(const ds3_request* request, const float value)
 *   void ds3_request_set_max_cache_percent(const ds3_request* request, const float value)
 ...
 *   void ds3_request_set_request_type_ds3_job_request_type(const ds3_request* request, const ds3_job_request_type value)
 */
LIBRARY_API ds3_request* ds3_init_modify_cache_throttle_rule_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_modify_cache_throttle_rule_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_cache_throttle_rule_response** response);
/**
 ...
 *   void ds3_request_set_always_rollback(const ds3_request* request, ds3_bool value)
...
/**
 * Optional Request Modifiers for ds3_init_put_s3_data_replication_rule_spectra_s3_request
 *
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_ds3_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_initial_data_placement_ds3_s3_initial_data_placement_policy(const ds3_request* request, const ds3_s3_initial_data_placement_policy value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
...
/**
 * Optional Request Modifiers for ds3_init_modify_azure_data_replication_rule_spectra_s3_request
 *
 *   void ds3_request_set_max_blob_part_size_in_bytes(const ds3_request* request, const uint64_t value)
 *   void ds3_request_set_replicate_deletes(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_type_ds3_data_replication_rule_type(const ds3_request* request, const ds3_data_replication_rule_type value)
...
/**
 * Optional Request Modifiers for ds3_init_modify_ds3_data_replication_rule_spectra_s3_request
 *
 *   void ds3_request_set_replicate_deletes(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_target_data_policy(const ds3_request* request, const char * const value)
 *   void ds3_request_set_type_ds3_data_replication_rule_type(const ds3_request* request, const ds3_data_replication_rule_type value)
...
/**
 * Optional Request Modifiers for ds3_init_modify_s3_data_replication_rule_spectra_s3_request
 *
 *   void ds3_request_set_initial_data_placement_ds3_s3_initial_data_placement_policy(const ds3_request* request, const ds3_s3_initial_data_placement_policy value)
 *   void ds3_request_set_max_blob_part_size_in_bytes(const ds3_request* request, const uint64_t value)
 *   void ds3_request_set_replicate_deletes(const ds3_request* request, ds3_bool value)
...
/**
 * Optional Request Modifiers for ds3_init_get_degraded_azure_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_degraded_ds3_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_degraded_s3_data_replication_rules_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_suspect_blob_azure_targets_spectra_s3_request
 *
 *   void ds3_request_set_blob_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_suspect_blob_ds3_targets_spectra_s3_request
 *
 *   void ds3_request_set_blob_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_suspect_blob_s3_targets_spectra_s3_request
 *
 *   void ds3_request_set_blob_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
LIBRARY_API ds3_request* ds3_init_delete_job_creation_failure_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_delete_job_creation_failure_spectra_s3_request(const ds3_client* client, const ds3_request* request);
...
/**
 * Optional Request Modifiers for ds3_init_get_job_creation_failures_spectra_s3_request
 *
 ...
 */
LIBRARY_API ds3_request* ds3_init_get_job_creation_failures_spectra_s3_request(void);
LIBRARY_API ds3_error* ds3_get_job_creation_failures_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_job_creation_failed_list_response** response);
/**
 * Optional Request Modifiers for ds3_init_get_job_entries_spectra_s3_request
 *
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
 *   void ds3_request_set_page_start_marker(const ds3_request* request, const char * const value)
 */
LIBRARY_API ds3_request* ds3_init_get_job_entries_spectra_s3_request(const char* job_id);
LIBRARY_API ds3_error* ds3_get_job_entries_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_job_entry_list_response** response);
...
LIBRARY_API ds3_request* ds3_init_get_job_summary_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_get_job_summary_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_job_summary_api_bean_response** response);
...
/**
 * Optional Request Modifiers for ds3_init_stage_objects_job_spectra_s3_request
 *
 *   void ds3_request_set_name(const ds3_request* request, const char * const value)
 *   void ds3_request_set_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 */
...
/**
 * Optional Request Modifiers for ds3_init_put_azure_target_failure_notification_registration_spectra_s3_request
 *
...
/**
 * Optional Request Modifiers for ds3_init_put_bucket_changes_notification_registration_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_format_ds3_http_response_format_type(const ds3_request* request, const ds3_http_response_format_type value)
 *   void ds3_request_set_naming_convention_ds3_naming_convention_type(const ds3_request* request, const ds3_naming_convention_type value)
 *   void ds3_request_set_notification_http_method_ds3_request_type(const ds3_request* request, const ds3_request_type value)
 */
LIBRARY_API ds3_request* ds3_init_put_bucket_changes_notification_registration_spectra_s3_request(const char* notification_end_point);
LIBRARY_API ds3_error* ds3_put_bucket_changes_notification_registration_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_bucket_changes_notification_registration_response** response);
/**
...
/**
 * Optional Request Modifiers for ds3_init_put_s3_target_failure_notification_registration_spectra_s3_request
 *
 *   void ds3_request_set_format_ds3_http_response_format_type(const ds3_request* request, const ds3_http_response_format_type value)
 *   void ds3_request_set_naming_convention_ds3_naming_convention_type(const ds3_request* request, const ds3_naming_convention_type value)
 *   void ds3_request_set_notification_http_method_ds3_request_type(const ds3_request* request, const ds3_request_type value)
...
LIBRARY_API ds3_request* ds3_init_delete_bucket_changes_notification_registration_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_delete_bucket_changes_notification_registration_spectra_s3_request(const ds3_client* client, const ds3_request* request);
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_target_failure_notification_registrations_spectra_s3_request
 *
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
...
LIBRARY_API ds3_request* ds3_init_get_bucket_changes_notification_registration_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_get_bucket_changes_notification_registration_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_bucket_changes_notification_registration_response** response);
/**
 * Optional Request Modifiers for ds3_init_get_bucket_changes_notification_registrations_spectra_s3_request
 *
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
 ...
 *   void ds3_request_set_user_id(const ds3_request* request, const char * const value)
 */
LIBRARY_API ds3_request* ds3_init_get_bucket_changes_notification_registrations_spectra_s3_request(void);
LIBRARY_API ds3_error* ds3_get_bucket_changes_notification_registrations_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_bucket_changes_notification_registration_list_response** response);
/**
 * Optional Request Modifiers for ds3_init_get_bucket_history_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 ...
 *   void ds3_request_set_page_start_marker(const ds3_request* request, const char * const value)
 */
LIBRARY_API ds3_request* ds3_init_get_bucket_history_spectra_s3_request(void);
LIBRARY_API ds3_error* ds3_get_bucket_history_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_bucket_history_event_list_response** response);
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_target_failure_notification_registrations_spectra_s3_request
 *
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
...
LIBRARY_API ds3_request* ds3_init_get_abm_config_spectra_s3_request(void);
LIBRARY_API ds3_error* ds3_get_abm_config_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_abm_config_api_bean_response** response);
/**
 * Optional Request Modifiers for ds3_init_get_feature_keys_spectra_s3_request
 *
 *   void ds3_request_set_error_message(const ds3_request* request, const char * const value)
...
LIBRARY_API ds3_request* ds3_init_cancel_test_tape_drive_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_cancel_test_tape_drive_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_tape_drive_response** response);
...
LIBRARY_API ds3_request* ds3_init_put_drive_dump_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_put_drive_dump_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_tape_drive_response** response);
 ...
 *
 *   void ds3_request_set_characterize(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_force(const ds3_request* request, ds3_bool value)
 */
...
/**
 * Optional Request Modifiers for ds3_init_get_blobs_on_tape_spectra_s3_request
 *
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
 *   void ds3_request_set_page_offset(const ds3_request* request, const int value)
 ...
 *
 *   void ds3_request_set_allow_rollback(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_eject_label(const ds3_request* request, const char * const value)
 *   void ds3_request_set_eject_location(const ds3_request* request, const char * const value)
...
/**
 * Optional Request Modifiers for ds3_init_raw_import_all_tapes_spectra_s3_request
 *
 *   void ds3_request_set_storage_domain_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_task_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 */
...
/**
 * Optional Request Modifiers for ds3_init_raw_import_tape_spectra_s3_request
 *
 *   void ds3_request_set_storage_domain_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_task_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 */
...
/**
 * Optional Request Modifiers for ds3_init_test_tape_drive_spectra_s3_request
 *
 *   void ds3_request_set_skip_clean(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_tape_id(const ds3_request* request, const char * const value)
 */
LIBRARY_API ds3_request* ds3_init_test_tape_drive_spectra_s3_request(const char *const resource_id);
LIBRARY_API ds3_error* ds3_test_tape_drive_spectra_s3_request(const ds3_client* client, const ds3_request* request, ds3_tape_drive_response** response);
/**
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_target_bucket_names_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_name(const ds3_request* request, const char * const value)
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_target_failures_spectra_s3_request
 *
 *   void ds3_request_set_error_message(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_target_read_preferences_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_azure_targets_spectra_s3_request
 *
...
/**
 * Optional Request Modifiers for ds3_init_import_azure_target_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 *   void ds3_request_set_user_id(const ds3_request* request, const char * const value)
...
/**
 * Optional Request Modifiers for ds3_init_modify_azure_target_spectra_s3_request
 *
...
/**
 * Optional Request Modifiers for ds3_init_register_azure_target_spectra_s3_request
 *
 *   void ds3_request_set_auto_verify_frequency_in_days(const ds3_request* request, const int value)
 *   void ds3_request_set_cloud_bucket_prefix(const ds3_request* request, const char * const value)
 *   void ds3_request_set_cloud_bucket_suffix(const ds3_request* request, const char * const value)
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_target_bucket_names_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_name(const ds3_request* request, const char * const value)
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_target_failures_spectra_s3_request
 *
 *   void ds3_request_set_error_message(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_target_read_preferences_spectra_s3_request
 *
 *   void ds3_request_set_bucket_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_last_page(const ds3_request* request, ds3_bool value)
 *   void ds3_request_set_page_length(const ds3_request* request, const int value)
...
/**
 * Optional Request Modifiers for ds3_init_get_s3_targets_spectra_s3_request
 *
...
/**
 * Optional Request Modifiers for ds3_init_import_s3_target_spectra_s3_request
 *
 *   void ds3_request_set_data_policy_id(const ds3_request* request, const char * const value)
 *   void ds3_request_set_priority_ds3_priority(const ds3_request* request, const ds3_priority value)
 *   void ds3_request_set_user_id(const ds3_request* request, const char * const value)
