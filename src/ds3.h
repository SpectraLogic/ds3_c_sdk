...
LIBRARY_API ds3_request* ds3_init_delete_objects(const char* bucket_name, ds3_bulk_object_list* object_list);
...
LIBRARY_API ds3_error* ds3_delete_objects(const ds3_client* client, const ds3_request* _request);
