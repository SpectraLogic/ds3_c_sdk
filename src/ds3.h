...
LIBRARY_API ds3_request* ds3_init_get_object_for_job(const char* bucket_name, const char* object_name, const char* job_id);
...
LIBRARY_API ds3_request* ds3_init_put_object_for_job(const char* bucket_name, const char* object_name, uint64_t size, const char* job_id);
...
LIBRARY_API ds3_bulk_object_list* ds3_convert_file_list_with_names_and_lengths(const char** names, const uint64_t* lengths, uint64_t num_files);
