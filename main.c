...
int main (int args, char * argv[]) {
    ...
    ds3_request * delete_request = ds3_init_delete_bucket(bucket);
    ds3_delete_bucket(client, delete_request);
    ds3_free_request(delete_request);

    request = ds3_init_get_service();
    response = ds3_get_service(client, request);
    ds3_free_request(request);
